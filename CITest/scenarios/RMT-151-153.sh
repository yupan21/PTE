...
node ./config_sc.js RMT-config-multi.json orderer.orderer1.url grpcs://${HOST1}:5005
node ./config_sc.js RMT-config-multi.json orderer.orderer2.url grpcs://${HOST1}:5005
...
node ./config_sc.js RMT-config-multi.json org2.peer2.requests grpcs://{HOST2}}:6053
node ./config_sc.js RMT-config-multi.json org2.peer1.events grpcs://{HOST2}}:7064
