...
# ssh root@172.16.50.153 -i ~/.ssh/id_rsa "cd /opt/go/src/github.com/hyperledger/fabric-test/fabric-sdk-node/test/PTE/CITest/RMT-auto; \
#     echo \"changing network ...\"; \
...
# # start network ---
# echo "connecting to client host ans startup the network "
# ssh root@172.16.50.153 -i ~/.ssh/id_rsa "cd /opt/go/src/github.com/hyperledger/fabric-test/fabric-sdk-node/test/PTE/CITest/scenarios/network; \
#     bash RMT-network-auto.sh"
# echo "sleeping 6 sec"
# sleep 6
# ## ending case ---
...
# # running test-----------------
# # reconfig pte
# cd /opt/go/src/github.com/hyperledger/fabric-test/fabric-sdk-node/test/PTE/CITest/RMT-auto/samplecc
