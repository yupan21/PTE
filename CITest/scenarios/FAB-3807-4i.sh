...
bash test_driver.sh -n -m FAB-3807-4i -p -c samplecc -t FAB-3835-4q
#### remove PTE log from synch-up ledger run
rm -f ../Logs/FAB-3835-4q*.log
#### execute testcase FAB-3807-4i: 4 threads invokes, golevelDB
bash test_driver.sh -t FAB-3807-4i
#### gather TPS from docker containers
bash get_peerStats.sh -r FAB-3807-4i -p peer0.org1.example.com peer0.org2.example.com -n $PREFIX -o $CWD -v

#### execute testcase FAB-3835-4q: 4 threads queries, golevelDB
bash test_driver.sh -t FAB-3835-4q
